...
make ARCH=arm CROSS_COMPILE=~/toolchain/arm-eabi-5.3/bin/arm-eabi- $DEFCONFIG
make -j32 ARCH=arm CROSS_COMPILE=~/toolchain/arm-eabi-5.3/bin/arm-eabi- | tee xmlog 2>&1
